...
====
----
pojo.Person person = restTemplate.getForObject("https://example.com/people/{id}", pojo.Person.class, 42);
----
====
...
----
	...
	parts.add("jsonPart", new pojo.Person("Jason"));
...
to an instance of the `pojo.Person` class:
...
----
	public class PersonMappingOperation extends MappingRecordOperation {
		...
		protected Object extractOutputData(Record outputRecord)
			...
			pojo.Person person = null;
			if (rs.next()) {
				pojo.Person person = new pojo.Person();
...
----
	public class MyDaoImpl extends CciDaoSupport implements MyDao {
		...
		public pojo.Person getPerson(int id) {
			PersonMappingOperation query = new PersonMappingOperation(getConnectionFactory());
			pojo.Person person = (pojo.Person) query.execute(new Integer(id));
			return person;
		}
	}
----
