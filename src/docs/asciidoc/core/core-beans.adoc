...
----
	<bean id="outer" class="...">
		...
		<property name="target">
			<bean class="com.example.pojo.Person"> <!-- this is the inner bean -->
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean name="john-classic" class="com.example.pojo.Person">
		...
		<bean name="jane" class="com.example.pojo.Person">
...
----
	@EventListener
	public void onPersonCreated(EntityCreatedEvent<pojo.Person> event) {
		...
	}
----
====
...
`class PersonCreatedEvent extends EntityCreatedEvent<pojo.Person> { ... }`).
